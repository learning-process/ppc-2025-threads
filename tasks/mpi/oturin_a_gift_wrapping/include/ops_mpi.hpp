...
namespace oturin_a_gift_wrapping_mpi {
...
class TestTaskMPI::PointSearcher {
  TestTaskMPI *p_;
 ...
 public:
  ...
  PointSearcher(TestTaskMPI *parent, int search_index) : p_(parent), search_index(search_index) {}
