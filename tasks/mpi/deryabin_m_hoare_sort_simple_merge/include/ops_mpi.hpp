...
void HoaraSort(std::vector<double>& a, size_t first, size_t last, oneapi::tbb::task_group& tg, size_t available_threads);
void MergeTwoParts(std::vector<double>& a, size_t first, size_t last, oneapi::tbb::task_group& tg, size_t available_threads);
