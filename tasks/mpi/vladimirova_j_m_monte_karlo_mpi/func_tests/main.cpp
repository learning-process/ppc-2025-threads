...
TEST(vladimirova_j_m_monte_karlo_mpi, test_zero_var) {
  ...
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(PiVal314));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(90000));
...
TEST(vladimirova_j_m_monte_karlo_mpi, test_one_point) {
  ...
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(val_b.data()));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(PiVal314));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(1));
  task_data_mpi->inputs_count.emplace_back(val_b.size());
  task_data_mpi->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_data_mpi->outputs_count.emplace_back(out.size());
  // Create Task
...
TEST(vladimirova_j_m_monte_karlo_mpi, test_PiVal_314) {
  ...
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(val_b.data()));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(PiVal314));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(9000));
  task_data_mpi->inputs_count.emplace_back(val_b.size());
  task_data_mpi->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_data_mpi->outputs_count.emplace_back(out.size());
  // Create Task
...
TEST(vladimirova_j_m_monte_karlo_mpi, test_PiVal_314_2) {
  ...
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(val_b.data()));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(PiVal314));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(70000));
  task_data_mpi->inputs_count.emplace_back(val_b.size());
  task_data_mpi->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_data_mpi->outputs_count.emplace_back(out.size());
  // Create Task
...
TEST(vladimirova_j_m_monte_karlo_mpi, test_SphereR3_1) {
  ...
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(val_b.data()));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(SphereR3));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(50000));
  task_data_mpi->inputs_count.emplace_back(val_b.size());
  task_data_mpi->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_data_mpi->outputs_count.emplace_back(out.size());
  // Create Task
...
TEST(vladimirova_j_m_monte_karlo_mpi, test_Rectangle34) {
  ...
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(val_b.data()));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(Rectangle34));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(30000));
  task_data_mpi->inputs_count.emplace_back(val_b.size());
  task_data_mpi->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_data_mpi->outputs_count.emplace_back(out.size());
  // Create Task
...
TEST(vladimirova_j_m_monte_karlo_mpi, test_Parallelogram333) {
  ...
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(val_b.data()));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(Parallelogram333));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(900));
  task_data_mpi->inputs_count.emplace_back(val_b.size());
  task_data_mpi->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_data_mpi->outputs_count.emplace_back(out.size());
  // Create Task
...
TEST(vladimirova_j_m_monte_karlo_mpi, test_BigParallelogram100100100) {
  ...
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(val_b.data()));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(BigParallelogram100100100));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(90));
  task_data_mpi->inputs_count.emplace_back(val_b.size());
  task_data_mpi->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_data_mpi->outputs_count.emplace_back(out.size());
  // Create Task
...
TEST(vladimirova_j_m_monte_karlo_mpi, test_Parabola_1_5_2_9) {
  ...
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(val_b.data()));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(Parabola));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(65000));
  task_data_mpi->inputs_count.emplace_back(val_b.size());
  task_data_mpi->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_data_mpi->outputs_count.emplace_back(out.size());
  // Create Task
...
TEST(vladimirova_j_m_monte_karlo_mpi, test_HypercubeX4Pr4433) {
  ...
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(val_b.data()));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(HypercubeX4Pr4433));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(90000));
  task_data_mpi->inputs_count.emplace_back(val_b.size());
  task_data_mpi->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_data_mpi->outputs_count.emplace_back(out.size());
...
TEST(vladimirova_j_m_monte_karlo_mpi, test_TriangleModuleMinus5) {
  ...
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(val_b.data()));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(TriangleModuleMinus5));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(65000));
  task_data_mpi->inputs_count.emplace_back(val_b.size());
  task_data_mpi->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_data_mpi->outputs_count.emplace_back(out.size());
...
TEST(vladimirova_j_m_monte_karlo_mpi, test_SomeRandomFunc) {
  ...
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(val_b.data()));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(SomeRandomFunc));
  task_data_mpi->inputs.emplace_back(reinterpret_cast<uint8_t *>(9000));
  task_data_mpi->inputs_count.emplace_back(val_b.size());
  task_data_mpi->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_data_mpi->outputs_count.emplace_back(out.size());
