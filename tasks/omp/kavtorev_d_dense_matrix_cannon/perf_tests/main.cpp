...
TEST(kavtorev_d_dense_matrix_cannon_omp, test_pipeline_run) {
  int n = 500;
  int m = 500;
  ...
  auto test_task_omp = std::make_shared<kavtorev_d_dense_matrix_cannon_omp::TestTaskSequential>(task_data_omp);
...
TEST(kavtorev_d_dense_matrix_cannon_omp, test_task_run) {
  int n = 500;
  int m = 500;
