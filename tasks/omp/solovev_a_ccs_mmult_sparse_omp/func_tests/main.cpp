...
TEST(solovev_a_ccs_mmult_sparse_omp, test_I) {
  solovev_a_matrix_omp::MatrixInCcsSparse m1(1, 1, 1);
  solovev_a_matrix_omp::MatrixInCcsSparse m2(1, 1, 1);
  solovev_a_matrix_omp::MatrixInCcsSparse m3;
...
TEST(solovev_a_ccs_mmult_sparse_omp, test_II) {
  ...
  solovev_a_matrix_omp::MatrixInCcsSparse m1(rows_m1, cols_m1, rows_m1);
  solovev_a_matrix_omp::MatrixInCcsSparse m2(rows_m2, cols_m2, cols_m2);
  solovev_a_matrix_omp::MatrixInCcsSparse m3(rows_m3, cols_m3, nnz_m3);
...
TEST(solovev_a_ccs_mmult_sparse_omp, test_III) {
  std::complex<double> vvector(2.0, 1.0);
  solovev_a_matrix_omp::MatrixInCcsSparse m1(50, 50);
  solovev_a_matrix_omp::MatrixInCcsSparse m2(50, 1);
  solovev_a_matrix_omp::MatrixInCcsSparse m3(50, 1);
...
TEST(solovev_a_ccs_mmult_sparse_omp, test_IV) {
  std::complex<double> vvector_one(2.0, 1.0);
  std::complex<double> vvector_two(3.0, 4.0);
  solovev_a_matrix_omp::MatrixInCcsSparse m1(5, 5);
  solovev_a_matrix_omp::MatrixInCcsSparse m2(5, 5);
  solovev_a_matrix_omp::MatrixInCcsSparse m3(5, 5);
...
TEST(solovev_a_ccs_mmult_sparse_omp, test_V) {
  std::complex<double> vvector(2.0, 1.0);
  solovev_a_matrix_omp::MatrixInCcsSparse m1(50, 50);
  solovev_a_matrix_omp::MatrixInCcsSparse m2(50, 50);
  solovev_a_matrix_omp::MatrixInCcsSparse m3(50, 50);
...
TEST(solovev_a_ccs_mmult_sparse_omp, test_V_random) {
  int rows = 50;
  int cols = 50;

  solovev_a_matrix_omp::MatrixInCcsSparse m1(rows, cols);
  solovev_a_matrix_omp::MatrixInCcsSparse m2(rows, cols);
  solovev_a_matrix_omp::MatrixInCcsSparse m3(rows, cols);
...
TEST(solovev_a_ccs_mmult_sparse_omp, test_identity_multiplication) {
  const int size = 50;
  solovev_a_matrix_omp::MatrixInCcsSparse i1(size, size, size);
  solovev_a_matrix_omp::MatrixInCcsSparse a(size, size, size * size);
  solovev_a_matrix_omp::MatrixInCcsSparse result(size, size, 0);
  ...
  solovev_a_matrix_omp::OMPMatMultCcs multiplication_task(task_data);
