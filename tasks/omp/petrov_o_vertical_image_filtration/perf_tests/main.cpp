...
TEST(petrov_o_vertical_image_filtration_omp, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_omp = std::make_shared<petrov_o_vertical_image_filtration_omp::TaskOpenMP>(task_data_omp);
...
TEST(petrov_o_vertical_image_filtration_omp, test_task_run) {
  constexpr int kCount = 5000;
