...
TEST(petrov_o_vertical_image_filtration_omp, test_gaussian_filter_3x3) {
...
TEST(petrov_o_vertical_image_filtration_omp, test_gaussian_filter_5x5) {
...
TEST(petrov_o_vertical_image_filtration_omp, test_gaussian_filter_const_data) {
  constexpr size_t kWidth = 5;
  constexpr size_t kHeight = 5;
...
TEST(petrov_o_vertical_image_filtration_omp, test_gaussian_filter_large_data) {
...
TEST(petrov_o_vertical_image_filtration_omp, test_gaussian_filter_rectangular) {
...
TEST(petrov_o_vertical_image_filtration_omp, test_gaussian_filter_1x1) {
...
TEST(petrov_o_vertical_image_filtration_omp, test_gaussian_filter_empty) {
