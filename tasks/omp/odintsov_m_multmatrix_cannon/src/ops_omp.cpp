...
// –аспараллеливаем по внешнему циклу по блокам по строкам (bi)
    ...
    // —двиги выполн€ем последовательно, чтобы обеспечить правильное изменение данных между шагами
