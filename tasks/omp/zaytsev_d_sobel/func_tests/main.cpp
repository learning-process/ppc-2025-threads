...
TEST(zaytsev_d_sobel_omp, test_validation_fail_count_in_out) {
  ...
  zaytsev_d_sobel_omp::TestTaskOpenMP task(task_data);
...
TEST(zaytsev_d_sobel_omp, SobelEdgeDetection_5x5) {
  ...
  zaytsev_d_sobel_omp::TestTaskOpenMP sobel_task(task_data);
...
TEST(zaytsev_d_sobel_omp, Sobel_12x12) {
...
TEST(zaytsev_d_sobel_omp, SobelEdgeDetection_UniformImage) {
  constexpr size_t kSize = 5;
...
#ifndef _WIN32
TEST(zaytsev_d_sobel_omp, SobelEdgeDetection_OpenCVImage) {
  cv::Mat input_img =
...
TEST(zaytsev_d_sobel_omp, Sobel_Circle) {
...
TEST(zaytsev_d_sobel_omp, RectangularImage_18x20) {
