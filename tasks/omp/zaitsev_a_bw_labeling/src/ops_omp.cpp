...
#define DEBUG_MIDLABELS false
#define DEBUG_CHUNK false
#define DEBUG_EQS false
...
void zaitsev_a_labeling_omp::Labeler::ComputeLabel(unsigned int i,
...
#pragma omp critical
  ...
  if (DEBUG_CHUNK) {
    std::cout << std::endl << "Chunk: " << chunk_ << std::endl;
  }
}
