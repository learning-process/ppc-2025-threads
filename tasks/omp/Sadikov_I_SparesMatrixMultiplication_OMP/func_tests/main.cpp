...
TEST(sadikov_i_sparse_matrix_multiplication_task_omp, test_random_matrixes) {
  constexpr auto kEpsilon = 0.000001;
  auto fmatrix = sadikov_i_sparse_matrix_multiplication_task_omp::GetRandomMatrix(240);
  auto smatrix = sadikov_i_sparse_matrix_multiplication_task_omp::GetRandomMatrix(240);
  ...
  task_data_seq->outputs_count.emplace_back(out.size());
  auto check_out =
      sadikov_i_sparse_matrix_multiplication_task_omp::BaseMatrixMultiplication(fmatrix, 12, 20, smatrix, 20, 12);
  sadikov_i_sparse_matrix_multiplication_task_omp::CCSMatrixOMP test_task_sequential(task_data_seq);
  ASSERT_EQ(test_task_sequential.Validation(), true);
  test_task_sequential.PreProcessing();
  test_task_sequential.Run();
...
TEST(sadikov_i_sparse_matrix_multiplication_task_omp, test_random_matrixes2) {
  constexpr auto kEpsilon = 0.000001;
