...
TEST(kozlova_e_contrast_enhancement_omp, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_sequential = std::make_shared<kozlova_e_contrast_enhancement_omp::TestTaskOpenMP>(task_data_seq);
...
TEST(kozlova_e_contrast_enhancement_omp, test_task_run) {
  constexpr int kSize = 100000000;
  size_t width = 10000;
  size_t height = 10000;
  // Create data
