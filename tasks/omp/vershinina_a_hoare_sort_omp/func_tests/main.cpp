...
TEST(vershinina_a_hoare_sort_omp, test_empty) {
  ...
  vershinina_a_hoare_sort_omp::TestTaskOpenMP test_task_omp(task_data_omp);
...
TEST(vershinina_a_hoare_sort_omp, test_not_random_reverse_order) {
...
TEST(vershinina_a_hoare_sort_omp, test_not_random_len_10) {
...
TEST(vershinina_a_hoare_sort_omp, test_not_random_len_100) {
...
TEST(vershinina_a_hoare_sort_omp, test_random_even_len_25) {
  std::vector<double> in;
...
TEST(vershinina_a_hoare_sort_omp, test_random_odd_len_50) {
  std::vector<double> in;
  std::vector<double> out(100);
...
TEST(vershinina_a_hoare_sort_omp, test_random_odd_len_100) {
  std::vector<double> in;
