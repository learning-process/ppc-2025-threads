...
TEST(shlyakov_m_shell_sort_omp, Test_Empty_Array) {
  ...
  shlyakov_m_shell_sort_omp::TestTaskOpenMP test_task_sequential(task_data_seq);
...
TEST(shlyakov_m_shell_sort_omp, Test_Reverse_Sorted_Array) {
  ...
  shlyakov_m_shell_sort_omp::TestTaskOpenMP test_task_sequential(task_data_omp);
  ASSERT_TRUE(test_task_sequential.Validation());
  ASSERT_TRUE(test_task_sequential.PreProcessing());
  ASSERT_TRUE(test_task_sequential.Run());
  ASSERT_TRUE(test_task_sequential.PostProcessing());
