...
TEST(shurigin_s_integrals_square_omp, test_integration_x_squared) {
  ...
  shurigin_s_integrals_square_omp::Integral integral_task(task_data);
...
TEST(shurigin_s_integrals_square_omp, test_integration_linear) {
  const double lower_bound = 0.0;
  const double upper_bound = 1.0;
  const int intervals = 1000;
...
TEST(shurigin_s_integrals_square_omp, test_integration_exponential) {
  const double lower_bound = 0.0;
  const double upper_bound = 1.0;
  const int intervals = 1000;
...
TEST(shurigin_s_integrals_square_omp, test_function_assignment) {
...
TEST(shurigin_s_integrals_square_omp, test_integration_cosine) {
  const double lower_bound = 0.0;
...
TEST(shurigin_s_integrals_square_omp, test_integration_logarithm) {
...
TEST(shurigin_s_integrals_square_omp, test_integration_reciprocal) {
  const double lower_bound = 1.0;
  const double upper_bound = 2.0;
  const int intervals = 1000;
...
TEST(shurigin_s_integrals_square_omp, test_integration_sqrt) {
  const double lower_bound = 0.0;
  const double upper_bound = 1.0;
  const int intervals = 1000;
...
TEST(shurigin_s_integrals_square_omp, test_integration_2d) {
...
TEST(shurigin_s_integrals_square_omp, test_integration_2d_square_sum) {
  const double lower_bound_x = 0.0;
  const double upper_bound_x = 1.0;
  const double lower_bound_y = 0.0;
  const double upper_bound_y = 1.0;
...
TEST(shurigin_s_integrals_square_omp, test_integration_2d_sin_sum) {
  const double lower_bound_x = 0.0;
...
TEST(shurigin_s_integrals_square_omp, test_integration_3d_product) {
  const double lower_bound_x = 0.0;
  const double upper_bound_x = 1.0;
  const double lower_bound_y = 0.0;
  const double upper_bound_y = 1.0;
