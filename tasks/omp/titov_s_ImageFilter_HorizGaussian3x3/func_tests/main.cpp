...
TEST(titov_s_image_filter_horiz_gaussian3x3_omp, test_10_1) {
...
TEST(titov_s_image_filter_horiz_gaussian3x3_omp, test_10_vertical_lines) {
  constexpr size_t kWidth = 10;
  constexpr size_t kHeight = 10;
...
TEST(titov_s_image_filter_horiz_gaussian3x3_omp, test_horizontal_lines) {
  constexpr size_t kWidth = 10;
  constexpr size_t kHeight = 10;
  std::vector<double> input_image(kWidth * kHeight, 0.0);
  std::vector<double> output_image(kWidth * kHeight, 0.0);
...
TEST(titov_s_image_filter_horiz_gaussian3x3_omp, test_empty_image) {
  constexpr size_t kWidth = 10;
  constexpr size_t kHeight = 10;
  std::vector<double> input_image(kWidth * kHeight, 0.0);
  std::vector<double> output_image(kWidth * kHeight, 0.0);
...
TEST(titov_s_image_filter_horiz_gaussian3x3_omp, test_sharp_transitions) {
  constexpr size_t kWidth = 10;
  constexpr size_t kHeight = 10;
  std::vector<double> input_image(kWidth * kHeight, 0.0);
  std::vector<double> output_image(kWidth * kHeight, 0.0);
...
TEST(titov_s_image_filter_horiz_gaussian3x3_omp, test_smooth_gradients) {
  constexpr size_t kWidth = 10;
  constexpr size_t kHeight = 10;
  std::vector<double> input_image(kWidth * kHeight, 0.0);
  std::vector<double> output_image(kWidth * kHeight, 0.0);
...
TEST(titov_s_image_filter_horiz_gaussian3x3_omp, test_all_max) {
  constexpr size_t kWidth = 10;
  constexpr size_t kHeight = 10;
...
TEST(titov_s_image_filter_horiz_gaussian3x3_omp, test_random_invariant_mean) {
