...
bool titov_s_image_filter_horiz_gaussian3x3_omp::ImageFilterOMP::ValidationImpl() {
  auto *kernel_ptr = reinterpret_cast<int *>(task_data->inputs[1]);
  kernel_ = std::vector<int>(kernel_ptr, kernel_ptr + 3);
...
bool titov_s_image_filter_horiz_gaussian3x3_omp::ImageFilterOMP::PostProcessingImpl() {
