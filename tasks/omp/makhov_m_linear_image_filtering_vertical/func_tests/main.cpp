...
TEST(makhov_m_linear_image_filtering_vertical_omp, test_synthetic_image_3x3) {
  int width = 3;
  int height = 3;
  ...
  makhov_m_linear_image_filtering_vertical_omp::TaskSequential test_task_sequential(task_data_seq);
...
TEST(makhov_m_linear_image_filtering_vertical_omp, test_synthetic_image_10x10) {
  int width = 10;
  int height = 10;
...
TEST(makhov_m_linear_image_filtering_vertical_omp, test_random_image_10x10) {
  int width = 10;
  int height = 10;
...
TEST(makhov_m_linear_image_filtering_vertical_omp, test_random_image_100x100) {
  int width = 100;
  int height = 100;
  std::vector<uint8_t> input_image = GenerateRandomImage(height, width);
  std::vector<uint8_t> output_image(width * height * 3, 0);
...
TEST(makhov_m_linear_image_filtering_vertical_omp, test_random_image_1000x1000) {
  int width = 1000;
  int height = 1000;
  std::vector<uint8_t> input_image = GenerateRandomImage(height, width);
  std::vector<uint8_t> output_image(width * height * 3, 0);
...
TEST(makhov_m_linear_image_filtering_vertical_omp, validation_test1) {
  int width = 3;
  int height = 1;
...
TEST(makhov_m_linear_image_filtering_vertical_omp, validation_test2) {
  int width = 3;
  int height = 1;
  std::vector<uint8_t> input_image = {0, 0, 0, 0, 0, 0, 0, 0, 0};
