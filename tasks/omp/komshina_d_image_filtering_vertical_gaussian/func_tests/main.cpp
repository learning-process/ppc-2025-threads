...
TEST(komshina_d_image_filtering_vertical_gaussian_omp, SinglePixelImage) {
  std::size_t width = 1;
  std::size_t height = 1;
...
TEST(komshina_d_image_filtering_vertical_gaussian_omp, EmptyImage) {
  std::size_t width = 0;
  std::size_t height = 0;
...
TEST(komshina_d_image_filtering_vertical_gaussian_omp, SingleRowImage) {
  std::size_t width = 3;
  std::size_t height = 1;
...
TEST(komshina_d_image_filtering_vertical_gaussian_omp, ZeroWidthImage) {
  std::size_t width = 0;
  std::size_t height = 3;
  std::vector<unsigned char> in = {255, 255, 255};
  std::vector<float> kernel = {1, 1, 1, 1, 1, 1, 1, 1, 1};
...
TEST(komshina_d_image_filtering_vertical_gaussian_omp, RandomImage) {
  std::size_t width = 5;
  std::size_t height = 5;
...
TEST(komshina_d_image_filtering_vertical_gaussian_omp, RandomImage2) {
  std::size_t width = 17;
