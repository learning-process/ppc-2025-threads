...
template <typename PixelType>
bool golovkin_contrast_stretching::ContrastStretchingOMP<PixelType>::PreProcessingImpl() {
...
template <typename PixelType>
bool golovkin_contrast_stretching::ContrastStretchingOMP<PixelType>::RunImpl() {
  if (image_size_ == 0) {
    return true;
  }
...
template <typename PixelType>
bool golovkin_contrast_stretching::ContrastStretchingOMP<PixelType>::PostProcessingImpl() {
  if (image_size_ == 0) {
    return true;
  }
...
template class golovkin_contrast_stretching::ContrastStretchingOMP<uint8_t>;
template class golovkin_contrast_stretching::ContrastStretchingOMP<uint16_t>;
template class golovkin_contrast_stretching::ContrastStretchingOMP<float>;