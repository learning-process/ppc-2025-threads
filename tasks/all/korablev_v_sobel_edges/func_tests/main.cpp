...
#include "all/korablev_v_sobel_edges/include/ops_seq.hpp"
...
class korablev_v_sobel_edges_test_all  // NOLINT(readability-identifier-naming)
    : public ::testing::TestWithParam<std::string> {};

#ifndef _WIN32
TEST_P(korablev_v_sobel_edges_test_all, compare_with_fixture) {
  boost::mpi::communicator world;

  const auto path = [](const std::string& f) { return "all/korablev_v_sobel_edges/data/" + f + ".png"; };
...
INSTANTIATE_TEST_SUITE_P(                 // NOLINT(misc-use-anonymous-namespace)
  korablev_v_sobel_edges_test_all,
  korablev_v_sobel_edges_test_all,
  ::testing::Values(
    "p1",
    "p2",
