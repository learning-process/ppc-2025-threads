...
TEST(tyurin_m_matmul_crs_complex_all, test_pipeline_run) {
  ...
  auto task = std::make_shared<tyurin_m_matmul_crs_complex_all::TestTaskAll>(data);
...
TEST(tyurin_m_matmul_crs_complex_all, test_task_run) {
  auto lhs = RandMatrix(730, 730, 0.22);
  auto rhs = RandMatrix(730, 730, 0.22);
