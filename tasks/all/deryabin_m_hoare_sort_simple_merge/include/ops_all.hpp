...
forwarding_and_merging(size_t world_rank, size_t step, bool is_even, size_t min_chunk_size_, size_t chunk_count_, size_t rest_, boost::mpi::communicator world_, std::vector<double> input_array_A_);
