...
TEST(yasakova_t_sparse_matrix_mult_all, test_matmul_only_real) {
  ...
  if (world.rank() == 0) {
    yasakova_t_sparse_matrix_mult_all::SparseMatrixCRS res =
        yasakova_t_sparse_matrix_mult_all::ConvertToSparse(out);
...
TEST(yasakova_t_sparse_matrix_mult_all, test_empty_matrices) {
  ...
  yasakova_t_sparse_matrix_mult_all::SparseMatrixCRS a(3, 3);
  yasakova_t_sparse_matrix_mult_all::SparseMatrixCRS b(3, 3);
  yasakova_t_sparse_matrix_mult_all::SparseMatrixCRS c(3, 3); // Ожидаемый результат - нулевая матрица
...
TEST(yasakova_t_sparse_matrix_mult_all, test_identity_matrix) {
  ...
  yasakova_t_sparse_matrix_mult_all::SparseMatrixCRS a(3, 3);
  yasakova_t_sparse_matrix_mult_all::SparseMatrixCRS b(3, 3); // Единичная матрица
  yasakova_t_sparse_matrix_mult_all::SparseMatrixCRS c(3, 3); // Ожидаемый результат равен a
