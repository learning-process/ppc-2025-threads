...
TEST(kolodkin_g_multiplication_matrix_all, test_matmul_only_real) {
  // Create data
...
TEST(kolodkin_g_multiplication_matrix_all, test_matmul_not_equal_rows_and_cols) {
  // Create data
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS a(3, 3);
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS b(5, 3);
  std::vector<Complex> in = {};
  std::vector<Complex> in_a;
  std::vector<Complex> in_b;
  std::vector<Complex> out(a.numCols * b.numRows * 100, 0);
...
TEST(kolodkin_g_multiplication_matrix_all, test_matmul_rectangular_matrix) {
  // Create data
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS a(2, 3);
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS b(3, 4);
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS c(2, 4);
  std::vector<Complex> in = {};
  std::vector<Complex> in_a;
  std::vector<Complex> in_b;
  std::vector<Complex> out(a.numCols * b.numRows * 100, 0);
...
TEST(kolodkin_g_multiplication_matrix_all, test_matmul_with_negative_elems) {
  // Create data
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS a(2, 2);
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS b(2, 2);
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS c(2, 2);
  std::vector<Complex> in = {};
  std::vector<Complex> in_a;
  std::vector<Complex> in_b;
  std::vector<Complex> out(a.numCols * b.numRows * 100, 0);
...
TEST(kolodkin_g_multiplication_matrix_all, test_matmul_row_by_col) {
  // Create data
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS a(1, 3);
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS b(3, 1);
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS c(1, 1);
  std::vector<Complex> in = {};
  std::vector<Complex> in_a;
  std::vector<Complex> in_b;
  std::vector<Complex> out(a.numCols * b.numRows * 100, 0);
