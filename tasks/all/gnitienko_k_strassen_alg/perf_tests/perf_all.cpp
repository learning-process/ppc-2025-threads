...
TEST(gnitienko_k_strassen_alg_all, test_pipeline_run) {
  size_t size = 1024;
  ...
  // Create Task
  auto test_task_all = std::make_shared<gnitienko_k_strassen_algorithm_all::StrassenAlgAll>(task_data_all);
...
TEST(gnitienko_k_strassen_alg_all, test_task_run) {
  size_t size = 1024;
