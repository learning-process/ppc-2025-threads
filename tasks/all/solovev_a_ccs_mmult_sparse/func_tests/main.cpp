...
TEST(solovev_a_ccs_mmult_sparse, test_I) {
  ...
  solovev_a_matrix_all::MatrixInCcsSparse m1(1, 1, 1);
  solovev_a_matrix_all::MatrixInCcsSparse m2(1, 1, 1);
  solovev_a_matrix_all::MatrixInCcsSparse m3;
  ...
  solovev_a_matrix_all::SeqMatMultCcs test_task_sequential(task_data_seq);
...
TEST(solovev_a_ccs_mmult_sparse, test_II) {
  ...
  solovev_a_matrix_all::MatrixInCcsSparse m1(rows_m1, cols_m1, rows_m1);
  solovev_a_matrix_all::MatrixInCcsSparse m2(rows_m2, cols_m2, cols_m2);
  solovev_a_matrix_all::MatrixInCcsSparse m3(rows_m3, cols_m3, nnz_m3);
...
TEST(solovev_a_ccs_mmult_sparse, test_III) {
  ...
  solovev_a_matrix_all::MatrixInCcsSparse m1(50, 50);
  solovev_a_matrix_all::MatrixInCcsSparse m2(50, 1);
  solovev_a_matrix_all::MatrixInCcsSparse m3(50, 1);
...
TEST(solovev_a_ccs_mmult_sparse, test_V) {
  ...
  std::complex<double> vvector(2.0, 1.0);
  solovev_a_matrix_all::MatrixInCcsSparse m1(50, 50);
  solovev_a_matrix_all::MatrixInCcsSparse m2(50, 50);
  solovev_a_matrix_all::MatrixInCcsSparse m3(50, 50);
...
TEST(solovev_a_ccs_mmult_sparse, test_V_random) {
  ...
  solovev_a_matrix_all::MatrixInCcsSparse m1(rows, cols);
  solovev_a_matrix_all::MatrixInCcsSparse m2(rows, cols);
  solovev_a_matrix_all::MatrixInCcsSparse m3(rows, cols);
...
TEST(solovev_a_ccs_mmult_sparse, test_identity_multiplication) {
  ...
  const int size = 50;
  solovev_a_matrix_all::MatrixInCcsSparse i1(size, size, size);
  solovev_a_matrix_all::MatrixInCcsSparse a(size, size, size * size);
  solovev_a_matrix_all::MatrixInCcsSparse result(size, size, 0);
  ...
  solovev_a_matrix_all::SeqMatMultCcs multiplication_task(task_data);
