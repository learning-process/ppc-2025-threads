...
TEST(laganina_e_component_labeling_all, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_omp = std::make_shared<laganina_e_component_labeling_all::TestTaskALL>(task_data_omp);
...
TEST(laganina_e_component_labeling_all, test_task_run) {
  boost::mpi::communicator world;
  constexpr int kCount = 2000;
