...
TEST(moiseev_a_mult_mat_mpi, test_large_matrix) {
  ...
  task_data_mpi->outputs.emplace_back(reinterpret_cast<uint8_t *>(c.data()));
  task_data_mpi->outputs_count.emplace_back(c.size());

  moiseev_a_mult_mat_mpi::MultMatMPI test_task_mpi(task_data_mpi);
...
TEST(moiseev_a_mult_mat_mpi, test_small_matrix) {
...
TEST(moiseev_a_mult_mat_mpi, test_matrix) {
...
TEST(moiseev_a_mult_mat_mpi, test_zero_matrix) {
...
TEST(moiseev_a_mult_mat_mpi, test_known_result) {
...
TEST(moiseev_a_mult_mat_mpi, test_repeated_values) {
  constexpr size_t kSize = 2;
...
TEST(moiseev_a_mult_mat_mpi, test_prime_values) {
  constexpr size_t kSize = 2;
...
TEST(moiseev_a_mult_mat_mpi, test_even_values) {
  constexpr size_t kSize = 2;
...
TEST(moiseev_a_mult_mat_mpi, test_negative_values) {
