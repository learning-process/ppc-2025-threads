...
TEST(fyodorov_m_shell_sort_with_even_odd_batcher_merge_mpi, test_validation_failure) {
...
TEST(fyodorov_m_shell_sort_with_even_odd_batcher_merge_mpi, test_empty_array_validation) {
  std::vector<int> input;
  std::vector<int> output;
...
TEST(fyodorov_m_shell_sort_with_even_odd_batcher_merge_mpi, test_single_element_array) {
