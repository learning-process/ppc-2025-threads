...
TEST(lysov_i_matrix_multiplication_fox_algorithm_mpi_tbb, Test_Matrix_Multiplication_Identity) {
  ...
  lysov_i_matrix_multiplication_fox_algorithm_mpi_tbb::TestTaskMPITBB matrix_multiplication(task_data_omp);
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_mpi_tbb, Test_Matrix_Multiplication_Arbitrary_Values) {
  boost::mpi::communicator world;
  size_t n = 3;
  size_t block_size = 1;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_mpi_tbb, Test_matrix_7x7) {
  boost::mpi::communicator world;
  size_t n = 7;
  size_t block_size = 3;
  ...
  std::vector<double> a =
      lysov_i_matrix_multiplication_fox_algorithm_mpi_tbb::GetRandomMatrix(n, min_gen_value, max_gen_value);
  std::vector<double> b =
      lysov_i_matrix_multiplication_fox_algorithm_mpi_tbb::GetRandomMatrix(n, min_gen_value, max_gen_value);
  std::vector<double> c(n * n, 0);
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_mpi_tbb, Test_matrix_16x16) {
  boost::mpi::communicator world;
  size_t n = 16;
  size_t block_size = 4;
  int min_gen_value = -1e3;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_mpi_tbb, Test_matrix_11x11) {
  boost::mpi::communicator world;
  size_t n = 11;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_mpi_tbb, Test_matrix_1x1) {
  boost::mpi::communicator world;
  size_t n = 1;
  size_t block_size = 3;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_mpi_tbb, Test_Matrix_Multiplication_Empty_MatrixA) {
  boost::mpi::communicator world;
  size_t n = 3;
  size_t block_size = 1;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_mpi_tbb, Test_Matrix_Multiplication_Empty_MatrixB) {
  boost::mpi::communicator world;
  size_t n = 3;
  size_t block_size = 1;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_mpi_tbb, Test_Matrix_Multiplication_Negative_Values) {
  boost::mpi::communicator world;
  size_t n = 3;
  size_t block_size = 2;
