...
TEST_F(ContrastStretchingMPIOMPTest, test_contrast_basic) {
...
TEST_F(ContrastStretchingMPIOMPTest, test_contrast_flat_image) {
...
TEST_F(ContrastStretchingMPIOMPTest, test_all_maximum) {
...
TEST_F(ContrastStretchingMPIOMPTest, test_gradient_image) {
...
TEST_F(ContrastStretchingMPIOMPTest, test_small_range) {
...
TEST_F(ContrastStretchingMPIOMPTest, test_extreme_values_only) {
...
TEST_F(ContrastStretchingMPIOMPTest, test_min_max_near_extremes) {
...
TEST_F(ContrastStretchingMPIOMPTest, test_alternating_values) {
...
TEST_F(ContrastStretchingMPIOMPTest, test_all_zeros) {
...
TEST_F(ContrastStretchingMPIOMPTest, test_random_mid_range_values) {
...
TEST_F(ContrastStretchingMPIOMPTest, test_empty_input) {
...
TEST_F(ContrastStretchingMPIOMPTest, test_uint16_pixels) {
