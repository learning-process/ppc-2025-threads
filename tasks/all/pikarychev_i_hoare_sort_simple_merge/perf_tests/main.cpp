...
TEST(pikarychev_i_hoare_sort_simple_merge_all, test_pipeline_run) {
  ...
  auto in = GenerateReverseSortedVector<int>(20000);
  ...
  auto task = pikarychev_i_hoare_sort_simple_merge::HoareMPITBB<int>(task_data);
