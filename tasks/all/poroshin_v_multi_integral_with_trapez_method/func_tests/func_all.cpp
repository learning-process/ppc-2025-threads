...
TEST(poroshin_v_multi_integral_with_trapez_method_all, invalid_size) {
  ...
  poroshin_v_multi_integral_with_trapez_method_all::TestTaskALL tmp_task_omp(task_omp, F1);
  if (world.rank() == 0) {
    ASSERT_FALSE(tmp_task_omp.ValidationImpl());
  }
}

TEST(poroshin_v_multi_integral_with_trapez_method_all, invalid_out) {
  boost::mpi::communicator world;
  size_t dim = 10;
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, minus_0_5_pi_0_5_pi_cos) {
  boost::mpi::communicator world;
  ...
  poroshin_v_multi_integral_with_trapez_method_all::TestTaskALL tmp_task_omp(task_omp, F1cos);
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, Eulers_integral) {
  boost::mpi::communicator world;
  std::vector<int> n = {1000};
  ...
  poroshin_v_multi_integral_with_trapez_method_all::TestTaskALL tmp_task_omp(task_omp, F1Euler);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, 05x05_area) {
  boost::mpi::communicator world;
  ...
  poroshin_v_multi_integral_with_trapez_method_all::TestTaskALL tmp_task_omp(task_omp, Area);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, 05x05_xy) {
  boost::mpi::communicator world;
  std::vector<int> n = {1000, 1000};
  std::vector<double> a = {0, 0};
  std::vector<double> b = {0.5, 0.5};
  ...
  poroshin_v_multi_integral_with_trapez_method_all::TestTaskALL tmp_task_omp(task_omp, F2);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, _0_04x0_04_tg_x_arctan_y) {
  boost::mpi::communicator world;
  std::vector<int> n = {1000, 1000};
  std::vector<double> a = {0, 0};
  ...
  poroshin_v_multi_integral_with_trapez_method_all::TestTaskALL tmp_task_omp(task_omp, F2advanced);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, 2x2_area) {
  boost::mpi::communicator world;
  std::vector<int> n = {1000, 1000};
  std::vector<double> a = {0, 0};
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, 2_3x1_4_area) {
  boost::mpi::communicator world;
  std::vector<int> n = {1000, 1000};
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, _0_2xminus2_0_area) {
  boost::mpi::communicator world;
  std::vector<int> n = {1000, 1000};
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, minus03_0_x_15_17_x_2_21_area) {
  boost::mpi::communicator world;
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, 08_1_x_15_17_x_18_2_xyz) {
  boost::mpi::communicator world;
  std::vector<int> n = {100, 100, 100};
  ...
  poroshin_v_multi_integral_with_trapez_method_all::TestTaskALL tmp_task_omp(task_omp, F3);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, 08_1_x_19_2_x_29_3_sinx_tgy_lnz) {
  boost::mpi::communicator world;
  std::vector<int> n = {100, 100, 100};
  ...
  poroshin_v_multi_integral_with_trapez_method_all::TestTaskALL tmp_task_omp(task_omp, F3advanced);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, _0_x_05_0_y_05_0_z_05_0_w_05_check_23) {
  boost::mpi::communicator world;
  ...
  poroshin_v_multi_integral_with_trapez_method_all::TestTaskALL tmp_task_omp(task_omp, F4);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, _0_x_05_0_y_05_0_z_05_0_w_05) {
  boost::mpi::communicator world;
...
TEST(poroshin_v_multi_integral_with_trapez_method_all, _0_xx_1_plus_0_yy_1_plus_0_zz_1_plus_0_ww_1) {
  boost::mpi::communicator world;
  ...
  poroshin_v_multi_integral_with_trapez_method_all::TestTaskALL tmp_task_omp(task_omp, F4advanced);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
