...
void zolotareva_a_sle_gradient_method_tbb::GenerateSle(std::vector<double> &a, std::vector<double> &b, int n) {
...
TEST(sequential_zolotareva_a_sle_gradient_method_tbb, test_pipeline_run) {
  const int n = 500;
  std::vector<double> a(n * n);
  std::vector<double> b(n);
  std::vector<double> x(n);
  zolotareva_a_sle_gradient_method_tbb::GenerateSle(a, b, n);
  ...
  auto test_task_sequential = std::make_shared<zolotareva_a_sle_gradient_method_tbb::TestTaskTBB>(task_data_seq);
  ...
  zolotareva_a_sle_gradient_method_tbb::TestTaskTBB task(task_data_seq);
...
TEST(sequential_zolotareva_a_sle_gradient_method_tbb, test_task_run) {
  const int n = 500;
  std::vector<double> a(n * n);
  std::vector<double> b(n);
  std::vector<double> x(n);
