...
TEST(lopatin_i_monte_carlo_tbb, test_pipeline_run) {
  ...
  auto test_task = std::make_shared<lopatin_i_monte_carlo_tbb::TestTaskTBB>(task_data, function);
...
TEST(lopatin_i_monte_carlo_tbb, test_task_run) {
  const int dimensions = 5;
  const int iterations = 10000000;
