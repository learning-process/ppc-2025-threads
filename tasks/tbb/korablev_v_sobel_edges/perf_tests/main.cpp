...
TEST(korablev_v_sobel_edges_tbb, test_pipeline_run) {
  ...
  // Create Task
  auto task = std::make_shared<korablev_v_sobel_edges_tbb::TestTask>(task_data);
...
TEST(korablev_v_sobel_edges_tbb, test_task_run) {
