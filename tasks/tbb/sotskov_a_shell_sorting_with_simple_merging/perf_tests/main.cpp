...
TEST(sotskov_a_shell_sorting_with_simple_merging_tbb, test_pipeline_run) {
  ...
  sotskov_a_shell_sorting_with_simple_merging_tbb::ShellSortWithSimpleMerging(expected);
  ...
  // Create Task
  auto test_task_tbb = std::make_shared<sotskov_a_shell_sorting_with_simple_merging_tbb::TestTaskTBB>(task_data_tbb);
