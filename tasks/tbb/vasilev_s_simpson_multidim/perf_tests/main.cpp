...
TEST(vasilev_s_simpson_multidim_tbb, test_pipeline_run) {
  ...
  auto task = std::make_shared<vasilev_s_simpson_multidim::SimpsonTaskTbb>(task_data);
...
TEST(vasilev_s_simpson_multidim_tbb, test_task_run) {
  auto [approxs, ifun, bounds] = BuildTest();
  double out{};
