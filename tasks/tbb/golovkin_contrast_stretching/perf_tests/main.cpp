...
TEST(golovkin_contrast_stretching_tbb, test_pipeline_run) {
  ...
  golovkin_contrast_stretching::ContrastStretchingTBB task(task_data_stl);
...
TEST(golovkin_contrast_stretching_tbb, test_task_run) {
  constexpr size_t kCount = 1'000'000;
