...
TEST(golovkin_contrast_stretching_tbb, test_contrast_basic) {
  ...
  golovkin_contrast_stretching::ContrastStretchingTBB task(task_data);
...
TEST(golovkin_contrast_stretching_tbb, test_contrast_flat_image) {
...
TEST(golovkin_contrast_stretching_tbb, test_all_maximum) {
...
TEST(golovkin_contrast_stretching_tbb, test_gradient_image) {
...
TEST(golovkin_contrast_stretching_tbb, test_small_range) {
...
TEST(golovkin_contrast_stretching_tbb, test_extreme_values_only) {
...
TEST(golovkin_contrast_stretching_tbb, test_min_max_near_extremes) {
...
TEST(golovkin_contrast_stretching_tbb, test_alternating_values) {
...
TEST(golovkin_contrast_stretching_tbb, test_all_zeros) {
...
TEST(golovkin_contrast_stretching_tbb, test_random_mid_range_values) {
...
TEST(golovkin_contrast_stretching_tbb, test_empty_input) {
...
TEST(golovkin_contrast_stretching_tbb, test_uint16_pixels) {
  ...
  golovkin_contrast_stretching::ContrastStretchingTBB<uint16_t> task(task_data);
  ASSERT_TRUE(task.Validation());
  ASSERT_TRUE(task.PreProcessing());
  ASSERT_TRUE(task.Run());
  ASSERT_TRUE(task.PostProcessing());
