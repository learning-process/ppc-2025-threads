...
TEST(kolokolova_d_integral_simpson_method_tbb, test_func_two_value1) {
...
TEST(kolokolova_d_integral_simpson_method_tbb, test_func_two_value2) {
...
TEST(kolokolova_d_integral_simpson_method_tbb, test_func_two_value3) {
...
TEST(kolokolova_d_integral_simpson_method_tbb, test_func_three_value1) {
...
TEST(kolokolova_d_integral_simpson_method_tbb, test_func_three_value2) {
...
TEST(kolokolova_d_integral_simpson_method_tbb, test_difficult_func1) {
...
TEST(kolokolova_d_integral_simpson_method_tbb, test_difficult_func2) {
...
TEST(kolokolova_d_integral_simpson_method_tbb, test_validation1) {
  auto func = [](std::vector<double> vec) { return vec[0] * vec[1]; };
  std::vector<int> step;
  std::vector<int> bord = {0, 1, 0, 3};
  double func_result = 0.0;
...
TEST(kolokolova_d_integral_simpson_method_tbb, test_validation2) {
  auto func = [](std::vector<double> vec) { return vec[0] * vec[1]; };
  std::vector<int> step = {2, 2};
  std::vector<int> bord;
  double func_result = 0.0;
...
TEST(kolokolova_d_integral_simpson_method_tbb, test_validation3) {
  auto func = [](std::vector<double> vec) { return vec[0] * vec[1]; };
  std::vector<int> step = {2, 2};
