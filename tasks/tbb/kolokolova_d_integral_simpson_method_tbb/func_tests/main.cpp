...
TEST(kolokolova_d_integral_simpson_method_tbb, test_matmul_50) {
  ...
  // Create Task
  kolokolova_d_integral_simpson_method_tbb::TestTaskTBB test_task_tbb(task_data_tbb);
...
TEST(kolokolova_d_integral_simpson_method_tbb, test_matmul_100_from_file) {
  std::string line;
