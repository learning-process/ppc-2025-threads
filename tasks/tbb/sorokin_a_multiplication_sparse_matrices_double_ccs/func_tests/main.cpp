...
TEST(sorokin_a_multiplication_sparse_matrices_double_ccs_tbb, test_3x3_x_3x3) {
  int m = 3;
  int k = 3;
  int n = 3;
...
TEST(sorokin_a_multiplication_sparse_matrices_double_ccs_tbb, test_2x3_x_3x2) {
  int m = 2;
  int k = 3;
  int n = 2;
...
TEST(sorokin_a_multiplication_sparse_matrices_double_ccs_tbb, test_3x2_x_2x4) {
  int m = 3;
  int k = 2;
  int n = 4;
...
TEST(sorokin_a_multiplication_sparse_matrices_double_ccs_tbb, test_val_k_0) {
  int m = 3;
  int k = 0;
  int n = 4;
