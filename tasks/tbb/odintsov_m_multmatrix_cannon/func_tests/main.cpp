...
std::vector<double> odintsov_m_mulmatrix_cannon_tbb::GenerateMatrix(int sz) {
...
std::vector<double> odintsov_m_mulmatrix_cannon_tbb::MultiplyMatrices(const std::vector<double> &a,
...
TEST(odintsov_m_mulmatrix_cannon_tbb, test_matrix_4) {
  ...
  task_data_omp->outputs.emplace_back(reinterpret_cast<uint8_t *>(out_tbb.data()));

  odintsov_m_mulmatrix_cannon_tbb::MulMatrixCannonTBB test_task_tbb(task_data_omp);
