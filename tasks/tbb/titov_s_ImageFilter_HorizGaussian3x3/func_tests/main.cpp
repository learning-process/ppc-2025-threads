...
TEST(titov_s_image_filter_horiz_gaussian3x3_tbb, test_10_1) {
  ...
  titov_s_image_filter_horiz_gaussian3x3_tbb::ImageFilterTBB image_filter_tbb(task_data_tbb);
...
TEST(titov_s_image_filter_horiz_gaussian3x3_tbb, test_10_vertical_lines) {
  constexpr size_t kWidth = 10;
  constexpr size_t kHeight = 10;
...
TEST(titov_s_image_filter_horiz_gaussian3x3_tbb, test_horizontal_lines) {
  constexpr size_t kWidth = 10;
  constexpr size_t kHeight = 10;
  std::vector<double> input_image(kWidth * kHeight, 0.0);
  std::vector<double> output_image(kWidth * kHeight, 0.0);
...
TEST(titov_s_image_filter_horiz_gaussian3x3_tbb, test_empty_image) {
  constexpr size_t kWidth = 10;
  constexpr size_t kHeight = 10;
  std::vector<double> input_image(kWidth * kHeight, 0.0);
  std::vector<double> output_image(kWidth * kHeight, 0.0);
...
TEST(titov_s_image_filter_horiz_gaussian3x3_tbb, test_sharp_transitions) {
  constexpr size_t kWidth = 10;
  constexpr size_t kHeight = 10;
  std::vector<double> input_image(kWidth * kHeight, 0.0);
  std::vector<double> output_image(kWidth * kHeight, 0.0);
...
TEST(titov_s_image_filter_horiz_gaussian3x3_tbb, test_smooth_gradients) {
  constexpr size_t kWidth = 10;
  constexpr size_t kHeight = 10;
  std::vector<double> input_image(kWidth * kHeight, 0.0);
  std::vector<double> output_image(kWidth * kHeight, 0.0);
...
TEST(titov_s_image_filter_horiz_gaussian3x3_tbb, test_all_max) {
  constexpr size_t kWidth = 10;
  constexpr size_t kHeight = 10;
...
TEST(titov_s_image_filter_horiz_gaussian3x3_tbb, test_random_invariant_mean) {
