...
TEST(kalyakina_a_shell_with_simple_merge_tbb, test_pipeline_run) {
  // Create data
  ...
  // Create Task
  auto test_task_tbb = std::make_shared<kalyakina_a_shell_with_simple_merge_tbb::ShellSortTBB>(task_data_tbb);
...
TEST(kalyakina_a_shell_with_simple_merge_tbb, test_task_run) {
  // Create data
  std::vector<int> in = CreateReverseSortedVector(3000000, -1500000);
  std::vector<int> out(in.size());
