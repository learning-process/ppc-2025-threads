...
TEST(dormidontov_e_kannon_tbb, mat36x36) {
  ...
  dormidontov_e_kannon_tbb::TbbTask task_seq(task_data_seq);
...
TEST(dormidontov_e_kannon_tbb, mat16) {
  tbb::global_control global_limit(tbb::global_control::max_allowed_parallelism, 4);
...
TEST(dormidontov_e_kannon_tbb, wrong_matrix_size) {
  tbb::global_control global_limit(tbb::global_control::max_allowed_parallelism, 4);
  matrix A(4 * 4);
  matrix B(3 * 3);
  matrix C(2 * 2);
...
TEST(dormidontov_e_kannon_tbb, mat_36x36) {
  tbb::global_control global_limit(tbb::global_control::max_allowed_parallelism, 4);
  size_t test_side_size = 36;
  size_t test_num_blocks = 6;
...
TEST(dormidontov_e_kannon_tbb, wrong_block_size) {
  tbb::global_control global_limit(tbb::global_control::max_allowed_parallelism, 4);
...
TEST(dormidontov_e_kannon_tbb, mat27x27) {
  tbb::global_control global_limit(tbb::global_control::max_allowed_parallelism, 4);
...
TEST(dormidontov_e_kannon_tbb, I_mat) {
  tbb::global_control global_limit(tbb::global_control::max_allowed_parallelism, 4);
  size_t test_side_size = 36;
  size_t test_num_blocks = 6;
  matrix A(test_side_size * test_side_size, 1.0);
