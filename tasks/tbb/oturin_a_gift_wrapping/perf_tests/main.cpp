...
namespace {
oturin_a_gift_wrapping_tbb::Coord RandCoord(int r) {
...
TEST(oturin_a_gift_wrapping_tbb, test_pipeline_run) {
  int count = 250000;
  ...
  // Create Task
  auto test_task_tbb = std::make_shared<oturin_a_gift_wrapping_tbb::TestTaskTBB>(task_data_tbb);
