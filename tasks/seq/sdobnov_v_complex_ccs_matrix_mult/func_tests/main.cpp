...
TEST(sdobnov_v_complex_ccs_matrix_mult_seq, Multiply_IncompatibleDimensions) {
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS m1(2, 3);
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS m2(4, 5);
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS result(2, 5);
  ...
  sdobnov_v_complex_ccs_matrix_mult_seq::SeqComplexCcsMatrixMult task(task_data);
  ASSERT_FALSE(task.ValidationImpl());
}

TEST(sdobnov_v_complex_ccs_matrix_mult_seq, Multiply_EmptyMatrices) {
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS m1(2, 3);
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS m2(3, 4);
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS result(2, 4);
  auto task_data = std::make_shared<ppc::core::TaskData>();
  task_data->inputs = {reinterpret_cast<uint8_t*>(&m1), reinterpret_cast<uint8_t*>(&m2)};
  task_data->outputs = {reinterpret_cast<uint8_t*>(&result)};
...
TEST(sdobnov_v_complex_ccs_matrix_mult_seq, Multiply_1x1) {
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS m1(1, 1);
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS m2(1, 1);
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS result(1, 1);
  ...
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS expected(1, 1);
...
TEST(sdobnov_v_complex_ccs_matrix_mult_seq, Multiply_2x3_3x2) {
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS a(2, 3);
  a.AddValue(0, 0, {1.0, 0.0});
  a.AddValue(1, 1, {0.0, 1.0});
  a.AddValue(2, 1, {1.0, -1.0});
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS b(3, 2);
  b.AddValue(0, 0, {0.0, 1.0});
  b.AddValue(1, 0, {2.0, 0.0});
  b.AddValue(0, 1, {1.0, 0.0});
  b.AddValue(0, 2, {1.0, 1.0});
  b.AddValue(1, 2, {0.0, 2.0});
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS result(2, 2);
  ...
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS expected(2, 2);
...
TEST(sdobnov_v_complex_ccs_matrix_mult_seq, Multiply_RandomSparseMatrices) {
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS m1 =
      sdobnov_v_complex_ccs_matrix_mult_seq::GenerateRandomMatrix(10, 5, 0.1, 1);
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS m2 =
      sdobnov_v_complex_ccs_matrix_mult_seq::GenerateRandomMatrix(5, 8, 0.1, 2);
  sdobnov_v_complex_ccs_matrix_mult_seq::SparseMatrixCCS result(10, 8);
