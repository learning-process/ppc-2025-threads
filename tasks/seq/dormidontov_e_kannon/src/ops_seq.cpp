...
bool dormidontov_e_kannon_seq::SeqTask::ValidationImpl() {
...
void dormidontov_e_kannon_seq::SeqTask::IterationShift() {
  std::swap(A_buffer_, A_);
  std::swap(B_buffer_, B_);
...
bool dormidontov_e_kannon_seq::SeqTask::PostProcessingImpl() {
