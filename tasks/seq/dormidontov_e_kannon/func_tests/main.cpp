...
TEST(dormidontov_e_kannon_seq, mat36x36) {
  ...
  dormidontov_e_kannon_seq::SeqTask task_seq(task_data_seq);
...
TEST(dormidontov_e_kannon_seq, mat16) {
...
TEST(dormidontov_e_kannon_seq, wrong_matrix_size) {
  matrix A(4 * 4);
  matrix B(3 * 3);
  matrix C(2 * 2);
...
TEST(dormidontov_e_kannon_seq, mat_36x36) {
  size_t test_side_size = 36;
  size_t test_num_blocks = 6;
...
TEST(dormidontov_e_kannon_seq, wrong_block_size) {
...
TEST(dormidontov_e_kannon_seq, mat27x27) {
...
TEST(dormidontov_e_kannon_seq, I_mat) {
  size_t test_side_size = 36;
  size_t test_num_blocks = 6;
  matrix A(test_side_size * test_side_size, 1.0);
