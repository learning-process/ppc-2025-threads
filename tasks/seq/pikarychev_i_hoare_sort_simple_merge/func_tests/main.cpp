...
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_0) { PerformTest(0, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_1) { PerformTest(1, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_2) { PerformTest(2, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_3) { PerformTest(3, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_4) { PerformTest(4, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_5) { PerformTest(5, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_15) { PerformTest(15, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_16) { PerformTest(16, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_17) { PerformTest(17, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_18) { PerformTest(18, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_19) { PerformTest(19, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_20) { PerformTest(20, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_21) { PerformTest(21, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_22) { PerformTest(22, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_23) { PerformTest(23, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_24) { PerformTest(24, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_25) { PerformTest(25, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_35) { PerformTest(35, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_36) { PerformTest(36, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_37) { PerformTest(37, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_38) { PerformTest(38, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_39) { PerformTest(39, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_40) { PerformTest(40, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_41) { PerformTest(41, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_49) { PerformTest(49, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_50) { PerformTest(50, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_51) { PerformTest(51, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_95) { PerformTest(95, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_96) { PerformTest(96, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_97) { PerformTest(97, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_98) { PerformTest(98, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_99) { PerformTest(99, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_100) { PerformTest(100, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_101) { PerformTest(101, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_102) { PerformTest(102, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_106) { PerformTest(106, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_107) { PerformTest(107, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_115) { PerformTest(115, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_116) { PerformTest(116, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_125) { PerformTest(125, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_126) { PerformTest(126, true); }
TEST(pikarychev_i_hoare_sort_simple_merge_seq, standard_127) { PerformTest(127, true); }
