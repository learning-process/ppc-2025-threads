...
class FominVConjugateGradientSeq : public ppc::core::Task {
 public:
  explicit FominVConjugateGradientSeq(ppc::core::TaskDataPtr task_data) : Task(std::move(task_data)) {}
  ...
  std::vector<double> MatrixVectorMultiply(const std::vector<double>& a, const std::vector<double>& x) const;
