...
TEST(golovkin_contrast_stretching_seq, test_contrast_basic) {
...
TEST(golovkin_contrast_stretching_seq, test_contrast_flat_image) {
...
TEST(golovkin_contrast_stretching_seq, test_all_maximum) {
...
TEST(golovkin_contrast_stretching_seq, test_gradient_image) {
...
TEST(golovkin_contrast_stretching_seq, test_small_range) {
...
TEST(golovkin_contrast_stretching_seq, test_extreme_values_only) {
...
TEST(golovkin_contrast_stretching_seq, test_min_max_near_extremes) {
...
TEST(golovkin_contrast_stretching_seq, test_alternating_values) {
...
TEST(golovkin_contrast_stretching_seq, test_all_zeros) {
...
TEST(golovkin_contrast_stretching_seq, test_random_mid_range_values) {
...
TEST(golovkin_contrast_stretching_seq, test_empty_input) {
...
TEST(golovkin_contrast_stretching_seq, test_uint16_pixels) {
