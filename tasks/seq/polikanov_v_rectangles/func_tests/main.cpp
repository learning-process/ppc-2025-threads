...
TEST(polikanov_v_rectangles_seq, exp__3D) {
  RunFuncTest(std::vector<polikanov_v_rectangles::IntegrationBound>(3, {0, 1}), 70, 4.97,
              [](const auto &p) { return std::exp(p[0]) * std::exp(p[1]) * std::exp(p[2]); });
}

TEST(polikanov_v_rectangles_seq, exp_pow_2__3D) {
  RunFuncTest(std::vector<polikanov_v_rectangles::IntegrationBound>(3, {0, 1}), 70, 31.31, [](const auto &p) {
...
TEST(polikanov_v_rectangles_seq, exp_arg_pow_2__3D) {
  RunFuncTest(std::vector<polikanov_v_rectangles::IntegrationBound>(3, {0, 1}), 70, 3.05, [](const auto &p) {
