...
TEST(karaseva_e_congrad_stl, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_stl = std::make_shared<karaseva_a_test_task_stl::TestTaskSTL>(task_data);
...
TEST(karaseva_e_congrad_stl, test_task_run) {
  constexpr int kSize = 10000;
