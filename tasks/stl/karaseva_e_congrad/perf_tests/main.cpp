...
TEST(karaseva_a_test_task_stl, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_sequential = std::make_shared<karaseva_a_test_task_stl::TestTaskSTL>(task_data_stl);
...
TEST(karaseva_a_test_task_stl, test_task_run) {
  constexpr int kCount = 10000;
