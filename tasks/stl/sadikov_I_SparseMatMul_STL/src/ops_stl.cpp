...
bool sadikov_i_sparse_matrix_multiplication_task_stl::CCSMatrixSTL::ValidationImpl() {
...
bool sadikov_i_sparse_matrix_multiplication_task_stl::CCSMatrixSTL::RunImpl() {
  m_answerMatrix_ = m_fMatrix_ * m_sMatrix_;
  return true;
}

bool sadikov_i_sparse_matrix_multiplication_task_stl::CCSMatrixSTL::PostProcessingImpl() {
