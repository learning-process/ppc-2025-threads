...
TEST(polikanov_v_rectangles_stl, exp__3D) {
...
TEST(polikanov_v_rectangles_stl, exp_pow_2__3D) {
...
TEST(polikanov_v_rectangles_stl, exp_arg_pow_2__3D) {
...
TEST(polikanov_v_rectangles_stl, exp_arg_pow_2_pow_2__3D) {
...
TEST(polikanov_v_rectangles_stl, sin_arg_pow_2_pow_2__2D) {
  RunFuncTest(std::vector<polikanov_v_rectangles::IntegrationBound>(2, {0, 1}), 150, 0.0,
              [](const auto &p) { return std::pow(std::pow(p[0], 2), 2) * std::pow(std::pow(p[1], 2), 2); });
}

TEST(polikanov_v_rectangles_stl, sin__3D) {
...
TEST(polikanov_v_rectangles_stl, sin_pow_2__3D) {
...
TEST(polikanov_v_rectangles_stl, sin_arg_pow_2__3D) {
