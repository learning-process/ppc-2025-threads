...
TEST(kolokolova_d_integral_simpson_method_stl, test_func_two_value1) {
...
TEST(kolokolova_d_integral_simpson_method_stl, test_func_two_value2) {
...
TEST(kolokolova_d_integral_simpson_method_stl, test_func_two_value3) {
...
TEST(kolokolova_d_integral_simpson_method_stl, test_func_three_value1) {
...
TEST(kolokolova_d_integral_simpson_method_stl, test_func_three_value2) {
