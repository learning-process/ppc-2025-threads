...
namespace {
void GenerateTestData(std::vector<alputov_i_graham_scan_stl::Point>& data) {
...
TEST(alputov_i_graham_scan_stl, test_pipeline_run) {
  ...
  auto task = std::make_shared<alputov_i_graham_scan_stl::TestTaskSTL>(task_data);
...
TEST(alputov_i_graham_scan_stl, test_task_run) {
  std::vector<alputov_i_graham_scan_stl::Point> input;
  GenerateTestData(input);
  std::vector<alputov_i_graham_scan_stl::Point> output(input.size());
