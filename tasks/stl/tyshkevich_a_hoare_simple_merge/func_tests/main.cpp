...
#include "stl/tyshkevich_a_hoare_simple_merge/include/ops_stl.hpp"
...
void TestSort(std::vector<T> &&in, Comparator cmp) {
  ...
  auto tt = tyshkevich_a_hoare_simple_merge_stl::CreateHoareTestTask<T>(dat, cmp);
...
TEST(tyshkevich_a_hoare_simple_merge_stl, test_0_gt) { TestSort<int>(0, std::greater<>()); }
TEST(tyshkevich_a_hoare_simple_merge_stl, test_0_lt) { TestSort<int>(0, std::less<>()); }

TEST(tyshkevich_a_hoare_simple_merge_stl, test_1_gt) { TestSort<int>(1, std::greater<>()); }
TEST(tyshkevich_a_hoare_simple_merge_stl, test_1_lt) { TestSort<int>(1, std::less<>()); }

TEST(tyshkevich_a_hoare_simple_merge_stl, test_2_gt) { TestSort<int>(2, std::greater<>()); }
TEST(tyshkevich_a_hoare_simple_merge_stl, test_2_lt) { TestSort<int>(2, std::less<>()); }

TEST(tyshkevich_a_hoare_simple_merge_stl, test_3_gt) { TestSort<int>(3, std::greater<>()); }
TEST(tyshkevich_a_hoare_simple_merge_stl, test_3_lt) { TestSort<int>(3, std::less<>()); }

TEST(tyshkevich_a_hoare_simple_merge_stl, test_5_gt) { TestSort<int>(5, std::greater<>()); }
TEST(tyshkevich_a_hoare_simple_merge_stl, test_5_lt) { TestSort<int>(5, std::less<>()); }

TEST(tyshkevich_a_hoare_simple_merge_stl, test_7_gt) { TestSort<int>(7, std::greater<>()); }
TEST(tyshkevich_a_hoare_simple_merge_stl, test_7_lt) { TestSort<int>(7, std::less<>()); }

TEST(tyshkevich_a_hoare_simple_merge_stl, test_9_gt) { TestSort<int>(9, std::greater<>()); }
TEST(tyshkevich_a_hoare_simple_merge_stl, test_9_lt) { TestSort<int>(9, std::less<>()); }

TEST(tyshkevich_a_hoare_simple_merge_stl, test_10_gt) { TestSort<int>(10, std::greater<>()); }
TEST(tyshkevich_a_hoare_simple_merge_stl, test_10_lt) { TestSort<int>(10, std::less<>()); }

TEST(tyshkevich_a_hoare_simple_merge_stl, test_11_gt) { TestSort<int>(11, std::greater<>()); }
TEST(tyshkevich_a_hoare_simple_merge_stl, test_11_lt) { TestSort<int>(11, std::less<>()); }
