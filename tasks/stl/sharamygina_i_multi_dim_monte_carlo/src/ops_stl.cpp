...
bool sharamygina_i_multi_dim_monte_carlo_stl::MultiDimMonteCarloTask::ValidationImpl() {
...
bool sharamygina_i_multi_dim_monte_carlo_stl::MultiDimMonteCarloTask::PostProcessingImpl() {
