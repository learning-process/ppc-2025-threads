...
TEST(sharamygina_i_multi_dim_monte_carlo_stl, WrongInputCountValidationTest) {
  ...
  sharamygina_i_multi_dim_monte_carlo_stl::MultiDimMonteCarloTask test_task(task_data);
  ASSERT_FALSE(test_task.ValidationImpl());
}

TEST(sharamygina_i_multi_dim_monte_carlo_stl, WrongOutputCountValidationTest) {
  int iterations = 30000;
  std::vector<double> boundaries = GetBoundaries(0.0, 1.0, 1);
  auto test_function = [](const std::vector<double>& values) {
    assert(values.size() == 2);
...
TEST(sharamygina_i_multi_dim_monte_carlo_stl, WrongBoundariesValidationTest) {
  int iterations = 30000;
  std::vector<double> boundaries = GetBoundaries(0.0, 1.0, 1);
  auto test_function = [](const std::vector<double>& values) {
    assert(values.size() == 2);
...
TEST(sharamygina_i_multi_dim_monte_carlo_stl, EmptyOutputValidationTest) {
  int iterations = 30000;
  std::vector<double> boundaries = GetBoundaries(0.0, 1.0, 1);
  auto test_function = [](const std::vector<double>& values) {
    assert(values.size() == 2);
...
TEST(sharamygina_i_multi_dim_monte_carlo_stl, EmptyInputValidationTest) {
  std::shared_ptr<ppc::core::TaskData> task_data = std::make_shared<ppc::core::TaskData>();
...
TEST(sharamygina_i_multi_dim_monte_carlo_stl, 1DSinFunction) {
  int iterations = 30000;
  std::vector<double> boundaries = GetBoundaries(0.0, 1.0, 1);
  auto test_function = [](const std::vector<double>& values) {
    assert(values.size() == 2);
...
TEST(sharamygina_i_multi_dim_monte_carlo_stl, 2DFunction) {
  int iterations = 30000;
...
TEST(sharamygina_i_multi_dim_monte_carlo_stl, 3DFunction) {
  int iterations = 30000;
...
TEST(sharamygina_i_multi_dim_monte_carlo_stl, 4DFunction) {
  int iterations = 30000;
...
TEST(sharamygina_i_multi_dim_monte_carlo_stl, 2DExpFunction) {
  int iterations = 30000;
...
TEST(sharamygina_i_multi_dim_monte_carlo_stl, 10DFunction) {
  int iterations = 30000;
...
TEST(sharamygina_i_multi_dim_monte_carlo_stl, 3DFunctionWithDifferentBoundaries) {
  int iterations = 30000;
...
TEST(sharamygina_i_multi_dim_monte_carlo_stl, 3DSinFunctionWithDifferentBoundaries) {
  int iterations = 30000;
  std::vector<double> boundaries = {1.0, 2.0, 1.3, 4.4, 0.5, 0.98};
  auto test_function = [](const std::vector<double>& values) {
    assert(values.size() == 3);
