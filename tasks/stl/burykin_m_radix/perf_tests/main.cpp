...
TEST(burykin_m_radix_stl, test_pipeline_run) {
  constexpr size_t kNumElements = 50000000;
  ...
  auto task = std::make_shared<burykin_m_radix_stl::RadixSTL>(task_data);
...
TEST(burykin_m_radix_stl, test_task_run) {
  constexpr size_t kNumElements = 50000000;
