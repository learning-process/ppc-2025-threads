...
TEST(lysov_i_matrix_multiplication_fox_algorithm_stl, Test_Matrix_Multiplication_Identity) {
  size_t n = 3;
  size_t block_size = 2;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_stl, Test_Matrix_Multiplication_Arbitrary_Values) {
  size_t n = 3;
  size_t block_size = 1;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_stl, Test_matrix_7x7) {
  size_t n = 7;
  size_t block_size = 3;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_stl, Test_matrix_16x16) {
  size_t n = 16;
  size_t block_size = 4;
  int min_gen_value = -1e3;
  int max_gen_value = 1e3;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_stl, Test_matrix_11x11) {
  size_t n = 11;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_stl, Test_matrix_1x1) {
  size_t n = 1;
  size_t block_size = 3;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_stl, Test_Matrix_Multiplication_Empty_MatrixA) {
  size_t n = 3;
  size_t block_size = 1;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_stl, Test_Matrix_Multiplication_Empty_MatrixB) {
  size_t n = 3;
  size_t block_size = 1;
...
TEST(lysov_i_matrix_multiplication_fox_algorithm_stl, Test_Matrix_Multiplication_Negative_Values) {
  size_t n = 3;
  size_t block_size = 2;
