...
TEST_P(PresetTests, run_and_verify) {
  ...
  vasilev_s_simpson_multidim::SimpsonTaskStl task(task_data);
...
// clang-format off
INSTANTIATE_TEST_SUITE_P(vasilev_s_simpson_multidim_test_stl, PresetTests, ::testing::Values( // NOLINT
    IntegrationTest{
      .approxs = 32,
