...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, invalid_size) {
  std::vector<int> n;
  std::vector<double> a;
  std::vector<double> b;
  ...
  poroshin_v_multi_integral_with_trapez_method_stl::TestTaskSTL tmp_task_omp(task_omp, F1);
  ASSERT_FALSE(tmp_task_omp.ValidationImpl());
}

TEST(poroshin_v_multi_integral_with_trapez_method_stl, invalid_out) {
  size_t dim = 10;
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, minus_0_5_pi_0_5_pi_cos) {
  ...
  task_omp->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_omp->outputs_count.emplace_back(out.size());
  poroshin_v_multi_integral_with_trapez_method_stl::TestTaskSTL tmp_task_omp(task_omp, F1cos);
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, Eulers_integral) {
  std::vector<int> n = {1000};
  ...
  task_omp->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_omp->outputs_count.emplace_back(out.size());
  poroshin_v_multi_integral_with_trapez_method_stl::TestTaskSTL tmp_task_omp(task_omp, F1Euler);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, 05x05_area) {
  ...
  task_omp->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_omp->outputs_count.emplace_back(out.size());
  poroshin_v_multi_integral_with_trapez_method_stl::TestTaskSTL tmp_task_omp(task_omp, Area);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, 05x05_xy) {
  std::vector<int> n = {1000, 1000};
  std::vector<double> a = {0, 0};
  std::vector<double> b = {0.5, 0.5};
  double eps = 1e-4;
  ...
  task_omp->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_omp->outputs_count.emplace_back(out.size());
  poroshin_v_multi_integral_with_trapez_method_stl::TestTaskSTL tmp_task_omp(task_omp, F2);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, _0_04x0_04_tg_x_arctan_y) {
  std::vector<int> n = {1000, 1000};
  std::vector<double> a = {0, 0};
  ...
  task_omp->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_omp->outputs_count.emplace_back(out.size());
  poroshin_v_multi_integral_with_trapez_method_stl::TestTaskSTL tmp_task_omp(task_omp, F2advanced);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, 2x2_area) {
  std::vector<int> n = {1000, 1000};
  std::vector<double> a = {0, 0};
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, 2_3x1_4_area) {
  std::vector<int> n = {1000, 1000};
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, _0_2xminus2_0_area) {
  std::vector<int> n = {1000, 1000};
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, minus03_0_x_15_17_x_2_21_area) {
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, 08_1_x_15_17_x_18_2_xyz) {
  std::vector<int> n = {100, 100, 100};
  ...
  task_omp->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_omp->outputs_count.emplace_back(out.size());
  poroshin_v_multi_integral_with_trapez_method_stl::TestTaskSTL tmp_task_omp(task_omp, F3);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, 08_1_x_19_2_x_29_3_sinx_tgy_lnz) {
  std::vector<int> n = {100, 100, 100};
  ...
  task_omp->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_omp->outputs_count.emplace_back(out.size());
  poroshin_v_multi_integral_with_trapez_method_stl::TestTaskSTL tmp_task_omp(task_omp, F3advanced);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, _0_x_05_0_y_05_0_z_05_0_w_05_check_23) {
  ...
  task_omp->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_omp->outputs_count.emplace_back(out.size());
  poroshin_v_multi_integral_with_trapez_method_stl::TestTaskSTL tmp_task_omp(task_omp, F4);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, _0_x_05_0_y_05_0_z_05_0_w_05) {
...
TEST(poroshin_v_multi_integral_with_trapez_method_stl, _0_xx_1_plus_0_yy_1_plus_0_zz_1_plus_0_ww_1) {
  std::vector<int> n = {120, 120, 120, 120};
  std::vector<double> a = {0.0, 0.0, 0.0, 0.0};
  ...
  task_omp->outputs.emplace_back(reinterpret_cast<uint8_t *>(out.data()));
  task_omp->outputs_count.emplace_back(out.size());
  poroshin_v_multi_integral_with_trapez_method_stl::TestTaskSTL tmp_task_omp(task_omp, F4advanced);
  ASSERT_TRUE(tmp_task_omp.ValidationImpl());
  tmp_task_omp.PreProcessingImpl();
  tmp_task_omp.RunImpl();
  tmp_task_omp.PostProcessingImpl();
