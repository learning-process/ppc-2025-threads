...
void vavilov_v_cannon_stl::CannonSTL::InitialShift() {
  ...
  int num_threads = std::min(ppc::util::GetPPCNumThreads(), static_cast<unsigned int>(num_blocks_));
...
void vavilov_v_cannon_stl::CannonSTL::BlockMultiply() {
  ...
  num_threads_ = std::min(ppc::util::GetPPCNumThreads(), static_cast<unsigned int>(num_blocks_));
