...
TEST(korotin_e_crs_multiplication_stl, test_rnd_50_50_50) {
...
TEST(korotin_e_crs_multiplication_stl, test_rndcrs_stat_zeroes) {
  const unsigned int m = 50;
  const unsigned int n = 50;
  const unsigned int p = 50;
  std::vector<double> a;
...
TEST(korotin_e_crs_multiplication_stl, test_rndcrs) {
  const unsigned int m = 50;
  const unsigned int n = 50;
  const unsigned int p = 50;
  std::vector<double> a;
...
TEST(korotin_e_crs_multiplication_stl, test_rnd_20_40_60) {
...
TEST(korotin_e_crs_multiplication_stl, test_rnd_17_37_53) {
...
TEST(korotin_e_crs_multiplication_stl, test_rnd_16_32_64) {
