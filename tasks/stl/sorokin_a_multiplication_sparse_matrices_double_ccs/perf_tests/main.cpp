...
TEST(sorokin_a_multiplication_sparse_matrices_double_ccs_stl, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_tbb =
      std::make_shared<sorokin_a_multiplication_sparse_matrices_double_ccs_stl::TestTaskTBB>(task_data_tbb);
