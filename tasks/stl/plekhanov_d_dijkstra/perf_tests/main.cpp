...
TEST(plekhanov_d_dijkstra_stl, test_pipeline_run) {
  constexpr size_t kNumVertices = 1000;
  ...
  auto test_task_stl = std::make_shared<plekhanov_d_dijkstra_stl::TestTaskSTL>(task_data_stl);
...
TEST(plekhanov_d_dijkstra_stl, test_task_run) {
  constexpr size_t kNumVertices = 1000;
  size_t start_vertex = 0;
