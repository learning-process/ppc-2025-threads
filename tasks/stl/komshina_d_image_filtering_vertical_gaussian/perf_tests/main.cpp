...
TEST(komshina_d_image_filtering_vertical_gaussian_stl, test_pipeline_run) {
  ...
  auto test_task = std::make_shared<komshina_d_image_filtering_vertical_gaussian_stl::TestTaskSTL>(task_data);
