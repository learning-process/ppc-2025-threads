...
std::vector<double> GeneratMatrix(filatev_v_foks_stl::MatrixSize size) {
...
TEST(filatev_v_foks_stl, test_matrix_4_4_block_2) {
  filatev_v_foks_stl::MatrixSize size_a(4, 4);
  filatev_v_foks_stl::MatrixSize size_b(4, 4);
  filatev_v_foks_stl::MatrixSize size_c(4, 4);
  ...
  filatev_v_foks_stl::Focks focks(task_data);
...
TEST(filatev_v_foks_stl, test_matrix_1_1_block_2) {
  filatev_v_foks_stl::MatrixSize size_a(1, 1);
  filatev_v_foks_stl::MatrixSize size_b(1, 1);
  filatev_v_foks_stl::MatrixSize size_c(1, 1);
...
TEST(filatev_v_foks_stl, test_matrix_4_4_block_3) {
  filatev_v_foks_stl::MatrixSize size_a(4, 4);
  filatev_v_foks_stl::MatrixSize size_b(4, 4);
  filatev_v_foks_stl::MatrixSize size_c(4, 4);
...
TEST(filatev_v_foks_stl, test_matrix_4_4_block_2_IdentityMatrix) {
  filatev_v_foks_stl::MatrixSize size_a(4, 4);
  filatev_v_foks_stl::MatrixSize size_b(4, 4);
  filatev_v_foks_stl::MatrixSize size_c(4, 4);
...
TEST(filatev_v_foks_stl, test_matrix_10_10_block_2_IdentityMatrix) {
  filatev_v_foks_stl::MatrixSize size_a(10, 10);
  filatev_v_foks_stl::MatrixSize size_b(10, 10);
  filatev_v_foks_stl::MatrixSize size_c(10, 10);
...
TEST(filatev_v_foks_stl, test_matrix_10_10_block_5_IdentityMatrix) {
  filatev_v_foks_stl::MatrixSize size_a(10, 10);
  filatev_v_foks_stl::MatrixSize size_b(10, 10);
  filatev_v_foks_stl::MatrixSize size_c(10, 10);
...
TEST(filatev_v_foks_stl, test_matrix_4_3_block_2) {
  filatev_v_foks_stl::MatrixSize size_a(3, 4);
  filatev_v_foks_stl::MatrixSize size_b(4, 3);
  filatev_v_foks_stl::MatrixSize size_c(4, 4);
...
TEST(filatev_v_foks_stl, test_matrix_4_1_block_2) {
  filatev_v_foks_stl::MatrixSize size_a(1, 4);
  filatev_v_foks_stl::MatrixSize size_b(4, 1);
  filatev_v_foks_stl::MatrixSize size_c(4, 4);
...
TEST(filatev_v_foks_stl, test_error_matrix_size_b) {
  filatev_v_foks_stl::MatrixSize size_a(1, 4);
  filatev_v_foks_stl::MatrixSize size_b(1, 4);
  filatev_v_foks_stl::MatrixSize size_c(4, 4);
...
TEST(filatev_v_foks_stl, test_error_matrix_size_c) {
  filatev_v_foks_stl::MatrixSize size_a(1, 4);
  filatev_v_foks_stl::MatrixSize size_b(4, 1);
  filatev_v_foks_stl::MatrixSize size_c(1, 1);
...
TEST(filatev_v_foks_stl, test_error_size_block) {
  filatev_v_foks_stl::MatrixSize size_a(1, 4);
  filatev_v_foks_stl::MatrixSize size_b(4, 1);
  filatev_v_foks_stl::MatrixSize size_c(4, 4);
