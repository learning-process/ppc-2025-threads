...
// clang-format off
TEST(tyurin_m_matmul_crs_complex_stl, test_regular_matrix_mult_1) {
...
TEST(tyurin_m_matmul_crs_complex_stl, test_regular_matrix_mult_2) {
...
TEST(tyurin_m_matmul_crs_complex_stl, test_crs_random_30x30p00mul30x30p00) {
  TestMatrixCRS(RandMatrix(30, 30, .0), RandMatrix(30, 30, .0));
}
TEST(tyurin_m_matmul_crs_complex_stl, test_crs_random_30x30p20mul30x30p20) {
  TestMatrixCRS(RandMatrix(30, 30, .20), RandMatrix(30, 30, .20));
}
TEST(tyurin_m_matmul_crs_complex_stl, test_crs_random_30x30p20mul30x30p50) {
  TestMatrixCRS(RandMatrix(30, 30, .20), RandMatrix(30, 30, .50));
}
TEST(tyurin_m_matmul_crs_complex_stl, test_crs_random_30x30p70mul30x30p50) {
  TestMatrixCRS(RandMatrix(30, 30, .70), RandMatrix(30, 30, .50));
}
TEST(tyurin_m_matmul_crs_complex_stl, test_crs_random_30x30p70mul30x30p20) {
  TestMatrixCRS(RandMatrix(30, 30, .70), RandMatrix(30, 30, .20));
}
TEST(tyurin_m_matmul_crs_complex_stl, test_crs_random_30x40p70mul40x30p60) {
  TestMatrixCRS(RandMatrix(30, 40, .70), RandMatrix(40, 30, .60));
}
TEST(tyurin_m_matmul_crs_complex_stl, test_crs_random_30x23p70mul23x30p63) {
  TestMatrixCRS(RandMatrix(30, 23, .70), RandMatrix(23, 30, .63));
}
TEST(tyurin_m_matmul_crs_complex_stl, test_crs_random_30x1p70mul1x1p63) {
